...
public static class ButtonUtility
{
    public static bool IsEnabled(Object target, MethodInfo method)
    {
        ...
        //else
        //{
        //    string message = enableIfAttribute.GetType().Title + " needs a valid boolean condition field, property or method name to work";
    ...
    public static bool IsVisible(Object target, MethodInfo method)
    {
        ...
        //else
        //{
        //    string message = showIfAttribute.GetType().Title + " needs a valid boolean condition field, property or method name to work";
        //    Debug.LogWarning(message, target);
