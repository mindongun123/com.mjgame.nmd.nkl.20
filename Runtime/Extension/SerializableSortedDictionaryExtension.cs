...
namespace MJGame
{
    ...
    [System.Serializable]
    public class SerializableSortedDictionaryExtension<TKey, TValue> : SerializableDictionaryExtension<TKey, TValue>
                                                                where TKey : IComparable
    {
        readonly SerializableSortedSetExtension<TKey> keys_casted;

        public SerializableSortedDictionaryExtension()
        : base(new SerializableSortedSetExtension<TKey>(), new List<TValue>())
        {
            keys_casted = (SerializableSortedSetExtension<TKey>)base.keys;
        }
        public SerializableSortedDictionaryExtension(IEnumerable<KeyValuePair<TKey, TValue>> collection) : this()
        {
