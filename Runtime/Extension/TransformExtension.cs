...
namespace MJGame
{
    public static class TransformExtension
    {
        ...
        /// <summary>
        /// Trả về một List<Transform> chứa tất cả các phần tử con của Transform parent.
        /// </summary>
        /// <param name="transform"></param>
        /// <returns></returns>
        public static List<Transform> ListChildren(this Transform transform)
        {
            var children = new List<Transform>();
        ...
        public static List<T> ListChildren<T>(this Transform transform) where T : Component
        {
        ...
        {
            var children = transform.ListChildren();
        ...
        public static IEnumerable<Transform> SelfAndAllChildren(this Transform transform)
        {
            ...
            while (openList.Any())
            {
                ...
                var children = currentChild.ListChildren();
        ...
        #region Parent
        /// <summary>
        /// Extension để lấy các phần tử con trong Transform và trả về dưới dạng Array<Transform> 
        /// </summary>
        /// <param name="parent"></param>
        /// <returns></returns>
        public static Transform[] GetChildrenArray(this Transform parent)
        {
            List<Transform> children = parent.ListChildren();
